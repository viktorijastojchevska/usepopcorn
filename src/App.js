  ...
  return (
    <>
      ...
      <Main>
        <Box>
          {!isLoading && !error && (
            <MoviesList movies={movies} onSelectedMovie={hadleSelectedMovie} />
          )}
        ...
        <Box>
          {selectedId ? (
            ...
            <>
              ...
              <WatchedMoviewList watched={watched} />
            </>
          )}
        </Box>
      </Main>
        ...
        <>
          ...
          <section>
            <div className="details-main">
              ...
              <p style={{ marginTop: "1rem" }}>Starring: {actors}</p>
              <p style={{ marginTop: "1rem" }}>Directed by: {director}</p>
            </div>
          </section>
        </>
      )}
...
function WatchedMoviewList({ watched }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
